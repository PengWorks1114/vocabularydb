...
export default function PracticeSettingsPage({ params }: PageProps) {
  ...
  const start = () => {
    router.push(
      `/wordbooks/${wordbookId}/study/practice/session?count=${count}&mode=${mode}&direction=${direction}`
    );
  };
      ...
      <Card className="max-w-md mx-auto">
        <CardHeader>
          <CardTitle className="text-center">
            <span suppressHydrationWarning>
              {mounted ? t("practiceDictation.settingsTitle") : ""}
            </span>
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                {(["word", "translation"] as Direction[]).map((d) => (
