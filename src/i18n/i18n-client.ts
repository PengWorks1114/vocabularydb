      ...
      en: {
        translation: {
          ...
          studyPage: {
            ...
            practice: "Practice Mode (Dictation)",
          ...
          practiceDictation: {
            settingsTitle: "Practice Mode (Dictation) Settings",
...
生贄,いけにえ,祭品、活祭/比喻被犧牲者,{{partOfSpeechCode}},古代では神に生贄を捧げる風習があった。（古代有向神獻上活祭的習俗。） 彼は生贄として選ばれた。（他被選為祭品。）,生贄を捧げる（獻上祭品）/神への生贄（獻給神的活祭）/生贄にされる（被當作祭品）,犠牲,救済,1.5,85,宗教與歷史色彩濃厚 現代常作比喻指被犧牲者 {{partOfSpeechName}}`,
      ...
      "zh-Hant": {
        translation: {
          ...
          practiceDictation: {
            settingsTitle: "練習模式(默寫)設定",
            start: "開始練習",
            correctMessage: "正確!",
            wrongMessage: "答錯囉!重新回答一次",
          },
          choice: {
...
生贄,いけにえ,祭品、活祭/比喻被犧牲者,{{partOfSpeechCode}},古代では神に生贄を捧げる風習があった。（古代有向神獻上活祭的習俗。） 彼は生贄として選ばれた。（他被選為祭品。）,生贄を捧げる（獻上祭品）/神への生贄（獻給神的活祭）/生贄にされる（被當作祭品）,犠牲,救済,1.5,85,宗教與歷史色彩濃厚 現代常作比喻指被犧牲者 {{partOfSpeechName}}`,
      ...
      ja: {
        translation: {
          ...
          practiceDictation: {
            settingsTitle: "練習モード（書き取り）設定",
            start: "練習を開始",
            correctMessage: "正解！",
            wrongMessage: "不正解です。もう一度！",
          },
          choice: {
